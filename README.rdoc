...
* Capistrano integration. See [https://github.com/DataDog/dogapi-rb/tree/master/lib/capistrano](https://github.com/DataDog/dogapi-rb/tree/master/lib/capistrano)
