...
dog.emit_event(Dogeapi::Event.new("Uh-oh, something bad happened",
...
dog.emit_event(Dogeapi::Event.new("Now that's better",
...
# You can use the following query: "tags:dogeapi tags:ruby" in the graph editor
