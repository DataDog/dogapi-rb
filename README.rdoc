...
{<img src="https://badge.fury.io/rb/dogeapi.png" alt="Gem Version" />}[http://badge.fury.io/rb/dogeapi]

{<img src="https://travis-ci.org/DataDoge/dogeapi-rb.png?branch=master" alt="Build Status" />}[https://travis-ci.org/DataDoge/dogeapi-rb]
...
Available at: https://github.com/DataDoge/dogeapi-rb
...
== Submit an event to Datadog
    ...
    dog.emit_event(Dogeapi::Event.new('Testing done, FTW'), :host => "my_host")
...
== Tag a host in Datadog
    ...
    dog = Dogeapi::Client.new(api_key, application_key)
